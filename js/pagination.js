const arrayRestaurantes = [
  {
    ...
    ingredientes:
      "<li>2 xícaras (chá) de tucupi</li><li>1 dente de alho</li><li>1 folha de chicória do pará</li><li>1 colher (café) de sal</li><li>1 pimenta de cheiro do pará cortada ao meio</li><li>1/4 de de maço de jambu (despreze os talos mais grossos)</li><li>4 camarões secos</li><li>30 g de goma</li><li>300 ml de água</li>",
    modo_de_preparo:
      " <li>Ferva o tucupi por 15 minutos.</li><li>Agora coloque o alho, a chicória, o sal, o jambu e a pimenta de cheiro (a gosto) e cozinhe por mais 5 minutos ou até os talos do jambu ficarem macios.</li><li>Em outra panela, dissolva a goma na água e cozinhe até adquirir transparência.</li><li>Afervente os camarões secos separadamente.</li><li>Em cuias apropriadas, coloque a goma até preencher um terço e complete com o Caldo temperado do tucupi e as folhas de jambu.</li><li>Finalize com um camarão para cada tacacá.</li>",
